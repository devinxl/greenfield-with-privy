...
import {shorten, type AddressString, stringifyTransaction} from '@/utils/utils';
...
const Transaction = () => {
  ...
  switch (chain?.id) {
    ...
    case 5:
      ...
      break;
    case 5600:
      txnHash = '0x9f7cbe0d9cb338adad50800c46bfd4cda61964033fa0875a60d744e554c5fbef'
      break;
  }
  ...
  console.log('data', txnHash, data, isError, isLoading)
  console.log({chain})
